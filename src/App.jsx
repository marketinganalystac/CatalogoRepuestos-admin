...
.ac-progress-overlay{
  ...
  display:flex;align-items:center;justify-content:center;
  background:linear-gradient(135deg, rgba(26,63,111,.70) 0%, rgba(0,96,160,.70) 55%, rgba(21,51,92,.70) 100%);
  opacity:0;pointer-events:none;transition:opacity .25s ease;
}
.ac-progress-overlay.active{opacity:1;pointer-events:all}
.ac-progress-card{
  background:linear-gradient(135deg, rgba(26,63,111,.50) 0%, rgba(0,96,160,.50) 55%, rgba(21,51,92,.50) 100%);
  border:none;border-radius:0;
