...
function CatalogoApp() {
  ...
  // Reportar la sección activa para el panel de "usuarios conectados"
  useEffect(()=>{ setSeccion?.(showDec ? 'Decodificador' : 'Catálogo'); }, [showDec, setSeccion]);
      ...
      <div className="ac-header">
        ...
        <div className="ac-hact">
          ...
          {isAdmin && <button className="btn btn-c" onClick={()=>{ loadReportes(); setShowReportes(true); }}>
            ...
            {reportes.filter(r=>r.estado==='abierto').length>0 && <span style={{background:'#C62828',color:'#fff',
