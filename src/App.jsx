...
function ClasiIcon({ clasi, sub, size=56 }) {
  ...
  if (imgSrc) {
    return <img src={imgSrc} alt={sub || clasi || 'Todas las categorías'} className="ac-clasi-img" draggable={false} />;
  }
  ...
  return (
    <div className="mo show">
      <div className="md sm">
        ...
        <div className="mf">
          <button className="btn btn-o" onClick={onClose}><Icon.X style={{marginRight:6,verticalAlign:-2}}/>Cancelar</button>
          <button className="btn btn-p" onClick={()=>{onReorder(localOrder);onClose();}}><Icon.Check style={{marginRight:6,verticalAlign:-2}}/>Aplicar</button>
        </div>
      </div>
    </div>
  );
