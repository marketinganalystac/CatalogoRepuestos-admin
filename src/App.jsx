...
:root{
  --bd:#0D1B2E;--bm:#06B6D4;--bl:rgba(6,182,212,.1);--gold:#F59E0B;--gl:rgba(245,158,11,.08);
  --g1:#0A0F1A;--g2:rgba(255,255,255,.07);--g3:rgba(255,255,255,.13);--g5:#5A7290;--g7:#8AAABF;--g9:#D4E0EC;
  --red:#F87171;--grn:#34D399;--org:#FB923C;
  --s1:#111827;--s2:#1A2535;--s3:#1F2E42;--s4:#253549;
  --sh-btn:0 2px 0 rgba(0,0,0,.5),0 4px 16px rgba(0,0,0,.35),inset 0 1px 0 rgba(255,255,255,.1);
  --sh-btn-sm:0 1px 0 rgba(0,0,0,.4),0 3px 10px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.08);
  --sh-hover:0 6px 24px rgba(6,182,212,.3),0 2px 8px rgba(0,0,0,.4),inset 0 1px 0 rgba(255,255,255,.15);
  --sh-active:0 1px 0 rgba(0,0,0,.5),inset 0 3px 6px rgba(0,0,0,.35);
  --sh-card:0 1px 3px rgba(0,0,0,.4),0 4px 16px rgba(0,0,0,.25),inset 0 1px 0 rgba(255,255,255,.04);
  --sh-card-hover:0 4px 20px rgba(6,182,212,.15),0 8px 32px rgba(0,0,0,.35),inset 0 1px 0 rgba(255,255,255,.06);
  --sh-modal:0 32px 80px rgba(0,0,0,.7),0 0 0 1px rgba(6,182,212,.15),0 0 100px rgba(6,182,212,.05);
  --sh-header:0 4px 30px rgba(0,0,0,.5),0 1px 0 rgba(6,182,212,.15) inset;
  --glass-bg:rgba(255,255,255,.05);--glass-border:rgba(255,255,255,.1);--glass-hover:rgba(255,255,255,.09);
}
*{box-sizing:border-box;margin:0;padding:0}
body{font-family:'Inter','Segoe UI',system-ui,-apple-system,sans-serif;background:var(--g1);color:var(--g9);min-height:100vh;-webkit-font-smoothing:antialiased;-webkit-tap-highlight-color:transparent;overflow-x:hidden}

.ac-header{background:linear-gradient(180deg,#060D18 0%,#0A1525 100%);padding:0 24px;border-bottom:1px solid rgba(6,182,212,.18);box-shadow:var(--sh-header);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;min-height:60px;position:relative;z-index:100}
.ac-header::after{content:'';position:absolute;bottom:0;left:0;right:0;height:1px;background:linear-gradient(90deg,transparent,rgba(6,182,212,.55),transparent);pointer-events:none}
.ac-hl{display:flex;align-items:center;gap:16px}
.ac-hdiv{width:1px;height:30px;background:rgba(255,255,255,.1)}
.ac-htitle .s1{font-size:.6rem;color:rgba(6,182,212,.7);text-transform:uppercase;letter-spacing:2px;font-weight:600;display:block}
.ac-htitle .s2{font-size:.92rem;color:#E8F4FF;font-weight:800;display:block;letter-spacing:-.01em;text-shadow:0 0 20px rgba(6,182,212,.3)}
.ac-badge{background:rgba(6,182,212,.1);color:var(--bm);font-size:.72rem;font-weight:700;padding:3px 12px;border-radius:20px;border:1px solid rgba(6,182,212,.25);box-shadow:0 0 12px rgba(6,182,212,.1);letter-spacing:.02em}
.ac-hact{display:flex;gap:6px;flex-wrap:wrap;align-items:center}

.btn{padding:8px 16px;border:none;border-radius:8px;font-size:.78rem;font-weight:700;cursor:pointer;transition:all .15s cubic-bezier(.2,0,.2,1);white-space:nowrap;position:relative;letter-spacing:.04em;-webkit-tap-highlight-color:transparent;touch-action:manipulation}
.btn:active{transform:translateY(1px) scale(.97)}
.btn-p{background:linear-gradient(180deg,#22D3EE 0%,#06B6D4 40%,#0891B2 100%);color:#041720;box-shadow:var(--sh-btn),0 0 0 1px rgba(6,182,212,.3),0 4px 15px rgba(6,182,212,.3);border-top:1px solid rgba(255,255,255,.25)}
.btn-p:hover{background:linear-gradient(180deg,#38D9EE 0%,#22C4E0 40%,#0EA5C4 100%);box-shadow:0 6px 24px rgba(6,182,212,.4),0 2px 8px rgba(0,0,0,.4),inset 0 1px 0 rgba(255,255,255,.2);transform:translateY(-2px)}
.btn-p:active{background:linear-gradient(180deg,#0891B2 0%,#06B6D4 100%);box-shadow:var(--sh-active);transform:translateY(1px)}
.btn-g{background:linear-gradient(180deg,#FCD34D 0%,#F59E0B 45%,#D97706 100%);color:#1A0C00;box-shadow:var(--sh-btn),0 0 0 1px rgba(245,158,11,.3),0 4px 16px rgba(245,158,11,.2);border-top:1px solid rgba(255,255,255,.3)}
.btn-g:hover{background:linear-gradient(180deg,#FDE68A 0%,#FCD34D 40%,#F59E0B 100%);box-shadow:0 6px 24px rgba(245,158,11,.35),0 2px 8px rgba(0,0,0,.4);transform:translateY(-2px)}
.btn-g:active{background:linear-gradient(180deg,#D97706 0%,#F59E0B 100%);box-shadow:var(--sh-active);transform:translateY(1px)}
.btn-c{background:rgba(255,255,255,.05);color:rgba(255,255,255,.85);border:1px solid rgba(255,255,255,.1);backdrop-filter:blur(12px);box-shadow:0 2px 8px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.07)}
.btn-c:hover{background:rgba(6,182,212,.12);border-color:rgba(6,182,212,.35);color:#E8F8FF;box-shadow:0 4px 16px rgba(6,182,212,.15),inset 0 1px 0 rgba(255,255,255,.1);transform:translateY(-1px)}
.btn-c:active{transform:translateY(1px);box-shadow:0 1px 4px rgba(0,0,0,.3)}
.btn-r{background:linear-gradient(180deg,#FC8181 0%,#F87171 40%,#EF4444 100%);color:#1A0000;box-shadow:var(--sh-btn),0 0 0 1px rgba(248,113,113,.3),0 4px 16px rgba(239,68,68,.2);border-top:1px solid rgba(255,255,255,.2)}
.btn-r:hover{background:linear-gradient(180deg,#FCA5A5 0%,#FC8181 40%,#F87171 100%);box-shadow:0 6px 24px rgba(239,68,68,.3);transform:translateY(-2px)}
.btn-r:active{transform:translateY(1px);box-shadow:var(--sh-active)}
.btn-o{background:rgba(255,255,255,.03);border:1px solid rgba(100,150,200,.25);color:var(--bm);box-shadow:0 2px 8px rgba(0,0,0,.25),inset 0 1px 0 rgba(255,255,255,.04)}
.btn-o:hover{background:rgba(6,182,212,.08);border-color:rgba(6,182,212,.4);box-shadow:0 4px 16px rgba(6,182,212,.12);transform:translateY(-1px)}
.btn-o:active{transform:translateY(1px);box-shadow:inset 0 2px 6px rgba(0,0,0,.3)}
.btn-dark{background:linear-gradient(180deg,var(--s3) 0%,var(--s2) 50%,#0C1520 100%);color:var(--g9);border:none;box-shadow:var(--sh-btn);border-top:1px solid rgba(255,255,255,.08)}
.btn-dark:hover{background:linear-gradient(180deg,var(--s4) 0%,var(--s3) 100%);box-shadow:var(--sh-hover);transform:translateY(-1px)}
.btn-dark:active{transform:translateY(1px);box-shadow:var(--sh-active)}
.btn-org{background:linear-gradient(180deg,#FB923C 0%,#F97316 45%,#EA580C 100%);color:#1A0600;box-shadow:var(--sh-btn),0 4px 16px rgba(249,115,22,.2);border-top:1px solid rgba(255,255,255,.2)}
.btn-org:hover{background:linear-gradient(180deg,#FDBA74 0%,#FB923C 40%,#F97316 100%);box-shadow:0 6px 24px rgba(249,115,22,.3);transform:translateY(-2px)}
.btn-org:active{transform:translateY(1px);box-shadow:var(--sh-active)}
.btn-slate{background:linear-gradient(180deg,rgba(71,85,105,.7) 0%,rgba(51,65,85,.8) 50%,rgba(30,41,59,.9) 100%);color:var(--g9);box-shadow:var(--sh-btn);border-top:1px solid rgba(255,255,255,.07);border:1px solid rgba(100,116,139,.2)}
.btn-slate:hover{background:linear-gradient(180deg,rgba(100,116,139,.6) 0%,rgba(71,85,105,.7) 100%);box-shadow:var(--sh-hover);transform:translateY(-1px)}
...
.btn-edit{padding:4px 10px;background:linear-gradient(180deg,#22D3EE 0%,#06B6D4 100%);color:#041720;border:none;border-radius:6px;font-size:.68rem;cursor:pointer;font-weight:700;box-shadow:var(--sh-btn-sm),0 0 10px rgba(6,182,212,.2);border-top:1px solid rgba(255,255,255,.2);transition:all .15s ease;touch-action:manipulation}
.btn-edit:hover{background:linear-gradient(180deg,#38E8FF 0%,#22D3EE 100%);box-shadow:0 4px 16px rgba(6,182,212,.4);transform:translateY(-1px)}
.btn-edit:active{transform:translateY(1px);box-shadow:var(--sh-active)}
.btn-del{padding:4px 10px;background:rgba(248,113,113,.08);color:var(--red);border:1px solid rgba(248,113,113,.2);border-radius:6px;font-size:.68rem;cursor:pointer;font-weight:700;margin-left:4px;box-shadow:0 2px 6px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.04);transition:all .15s ease;touch-action:manipulation}
.btn-del:hover{background:linear-gradient(180deg,#FC8181 0%,#EF4444 100%);color:#1A0000;border-color:transparent;box-shadow:0 4px 16px rgba(239,68,68,.35);transform:translateY(-1px)}
.btn-del:active{transform:translateY(1px)}
.btn-copy{padding:2px 7px;background:rgba(6,182,212,.08);border:1px solid rgba(6,182,212,.18);border-radius:4px;font-size:.64rem;cursor:pointer;color:var(--bm);font-weight:700;margin-left:5px;box-shadow:0 1px 4px rgba(0,0,0,.3);transition:all .14s ease}
.btn-copy:hover{background:linear-gradient(180deg,#22D3EE 0%,#06B6D4 100%);color:#041720;border-color:transparent;box-shadow:0 4px 12px rgba(6,182,212,.35);transform:translateY(-1px)}
.btn-copy:active{transform:translateY(1px)}

.ac-sp{background:var(--s1);border-bottom:1px solid var(--g2);padding:14px 24px;box-shadow:0 4px 16px rgba(0,0,0,.2)}
.ac-fg{display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;margin-bottom:12px}
.ac-fl{display:flex;flex-direction:column;gap:4px}
.ac-fl label{font-size:.62rem;color:var(--bm);font-weight:700;text-transform:uppercase;letter-spacing:1px;opacity:.85}
select,input[type=text]{background:var(--s2);border:1px solid var(--g3);color:var(--g9);padding:9px 12px;border-radius:8px;font-size:.82rem;outline:none;transition:all .18s;width:100%;box-shadow:inset 0 2px 6px rgba(0,0,0,.25);-webkit-appearance:none;appearance:none}
select:focus,input[type=text]:focus{border-color:var(--bm);background:var(--s3);box-shadow:0 0 0 2px rgba(6,182,212,.2),inset 0 1px 4px rgba(0,0,0,.2)}
.ac-sr{display:flex;gap:8px;align-items:flex-end;flex-wrap:wrap}
.ac-sr .ac-fl{flex:1;min-width:180px}

.ac-sb{background:linear-gradient(90deg,#060D18 0%,#0A1525 100%);padding:6px 24px;display:flex;align-items:center;gap:14px;font-size:.74rem;color:rgba(255,255,255,.45);flex-wrap:wrap;border-bottom:1px solid var(--g2)}
.ac-sb strong{color:var(--bm);font-weight:700}
.ac-sep{color:rgba(255,255,255,.15)}
.ac-tag{display:inline-flex;align-items:center;padding:2px 9px;border-radius:10px;font-size:.65rem;font-weight:700;color:var(--g9);background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.1)}

.ac-qs{background:var(--s1);border-bottom:1px solid var(--g2);padding:10px 24px;display:flex;gap:12px;flex-wrap:wrap;align-items:center}
.ac-qi{display:flex;align-items:center;gap:8px;background:var(--s2);border:1px solid var(--g2);border-radius:10px;padding:7px 16px;box-shadow:var(--sh-card);transition:all .2s}
.ac-qi:hover{border-color:rgba(6,182,212,.2);box-shadow:var(--sh-card-hover)}
.ac-qi .n{font-size:1.05rem;font-weight:900;color:var(--bm);line-height:1;letter-spacing:-.02em}
.ac-qi .l{color:var(--g5);font-size:.62rem;font-weight:600;text-transform:uppercase;letter-spacing:.6px}
.ac-qsep{width:1px;height:28px;background:var(--g2)}

.ac-tw{overflow:auto;max-height:calc(100vh - 310px);background:var(--s1);-webkit-overflow-scrolling:touch}
table{width:100%;border-collapse:collapse;font-size:.8rem}
thead th{background:linear-gradient(180deg,#0A1320 0%,#0D1B2E 100%);color:rgba(255,255,255,.55);padding:10px 14px;text-align:left;font-size:.62rem;font-weight:700;text-transform:uppercase;letter-spacing:.9px;position:sticky;top:0;z-index:10;white-space:nowrap;border-right:1px solid rgba(255,255,255,.04);cursor:pointer;user-select:none;transition:.15s;box-shadow:0 2px 8px rgba(0,0,0,.3),inset 0 -1px 0 rgba(6,182,212,.08)}
thead th:hover,thead th.sorted{background:linear-gradient(180deg,#102030 0%,#142840 100%);color:var(--bm)}
thead th .si{margin-left:4px;opacity:.25;font-size:.6rem}
...
tbody tr:hover{background:linear-gradient(90deg,rgba(6,182,212,.05) 0%,rgba(6,182,212,.02) 100%)}
tbody tr:nth-child(even){background:rgba(255,255,255,.018)}
tbody tr:nth-child(even):hover{background:linear-gradient(90deg,rgba(6,182,212,.06) 0%,rgba(6,182,212,.025) 100%)}
tbody td{padding:8px 14px;vertical-align:middle;color:var(--g9)}
.cm{font-weight:800;color:#E8F4FF;white-space:nowrap;font-size:.83rem;letter-spacing:.01em}
.cmo{color:var(--g5);white-space:nowrap;font-weight:500;font-size:.76rem}
.ca{font-family:'JetBrains Mono','Courier New',monospace;color:#94C3D4;font-size:.74rem;font-weight:600;background:rgba(148,195,212,.07);padding:2px 8px;border-radius:5px;display:inline-block;white-space:nowrap;border:1px solid rgba(148,195,212,.14)}
.cc{font-family:'JetBrains Mono','Courier New',monospace;color:#34D399;font-size:.74rem;font-weight:700;background:rgba(52,211,153,.08);padding:2px 8px;border-radius:5px;display:inline-block;white-space:nowrap;border:1px solid rgba(52,211,153,.2);box-shadow:0 0 8px rgba(52,211,153,.06)}
.cds{color:var(--g7);font-weight:500;font-size:.8rem}
.ct{display:inline-block;padding:2px 9px;border-radius:9px;font-size:.65rem;font-weight:700;color:var(--g9);white-space:nowrap;box-shadow:0 2px 6px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.1)}
.cs{color:var(--g5);font-size:.73rem;font-style:italic;opacity:.45}
.cac{white-space:nowrap;text-align:center}
.ac-mark{background:rgba(6,182,212,.18);color:#7DDFF0;border-radius:2px;padding:0 2px;font-weight:700;outline:1px solid rgba(6,182,212,.25)}

.ac-pg{background:var(--s1);padding:10px 24px;display:flex;align-items:center;gap:5px;border-top:1px solid var(--g2);flex-wrap:wrap}
.pb{padding:6px 12px;border:1px solid var(--g3);background:var(--s2);color:var(--g7);border-radius:7px;cursor:pointer;font-size:.74rem;font-weight:600;transition:all .14s ease;box-shadow:0 2px 6px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.04);touch-action:manipulation}
.pb:hover{background:rgba(6,182,212,.1);border-color:rgba(6,182,212,.3);color:var(--bm);box-shadow:0 4px 14px rgba(6,182,212,.12);transform:translateY(-1px)}
.pb:active{transform:translateY(1px);box-shadow:inset 0 2px 4px rgba(0,0,0,.3)}
.pb.active{background:linear-gradient(180deg,#22D3EE 0%,#06B6D4 100%);border-color:var(--bm);color:#041720;font-weight:800;box-shadow:var(--sh-btn-sm),0 0 12px rgba(6,182,212,.3)}
.pb:disabled{opacity:.2;cursor:default;transform:none!important;box-shadow:none!important}
.pi{font-size:.74rem;color:var(--g5);margin-left:auto}

.mo{display:none;position:fixed;inset:0;background:rgba(4,10,20,.78);z-index:1000;align-items:center;justify-content:center;backdrop-filter:blur(12px);padding:16px}
.mo.show{display:flex}
.md{background:var(--s2);border-radius:16px;width:min(680px,100%);max-height:90vh;overflow-y:auto;box-shadow:var(--sh-modal);animation:pop .22s cubic-bezier(.34,1.4,.64,1);border:1px solid rgba(6,182,212,.12)}
...
.mh{padding:16px 22px 14px;border-bottom:1px solid rgba(6,182,212,.12);display:flex;align-items:center;justify-content:space-between;background:linear-gradient(135deg,rgba(6,182,212,.08),rgba(6,182,212,.03));border-radius:16px 16px 0 0}
.mh.danger{background:linear-gradient(135deg,rgba(239,68,68,.12),rgba(239,68,68,.04));border-bottom-color:rgba(239,68,68,.18)}
.mh h2{font-size:.9rem;color:#E8F4FF;font-weight:700;letter-spacing:-.01em}
.mx{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);font-size:1rem;cursor:pointer;color:var(--g7);border-radius:50%;width:28px;height:28px;display:flex;align-items:center;justify-content:center;transition:all .15s}
.mx:hover{background:rgba(239,68,68,.2);border-color:rgba(239,68,68,.3);color:var(--red)}
.mb{padding:20px 22px}
.mf{padding:14px 22px;border-top:1px solid var(--g2);display:flex;justify-content:flex-end;gap:8px;flex-wrap:wrap;background:rgba(0,0,0,.2);border-radius:0 0 16px 16px}
.fgrid{display:grid;grid-template-columns:1fr 1fr;gap:12px}
.fg2{display:flex;flex-direction:column;gap:4px}
.fg2.full{grid-column:1/-1}
.fg2 label{font-size:.62rem;color:var(--bm);font-weight:700;text-transform:uppercase;letter-spacing:.8px;opacity:.85}
.fg2 input,.fg2 select{background:var(--s2);border:1px solid var(--g3);color:var(--g9);padding:9px 12px;border-radius:8px;font-size:.84rem;outline:none;transition:.18s;width:100%;box-shadow:inset 0 2px 6px rgba(0,0,0,.25)}
.fg2 input:focus,.fg2 select:focus{border-color:var(--bm);background:var(--s3);box-shadow:0 0 0 2px rgba(6,182,212,.2),inset 0 1px 4px rgba(0,0,0,.2)}
.fg2 input.err{border-color:var(--red);background:rgba(239,68,68,.05);box-shadow:0 0 0 2px rgba(239,68,68,.1)}
.em{font-size:.66rem;color:var(--red);margin-top:2px}
.ib{border:2px dashed rgba(6,182,212,.18);border-radius:12px;padding:28px;text-align:center;background:rgba(6,182,212,.03);cursor:pointer;transition:.2s}
.ib:hover,.ib.drag{border-color:var(--bm);background:rgba(6,182,212,.07);box-shadow:0 0 24px rgba(6,182,212,.1)}
.ib .icon{font-size:2.4rem;margin-bottom:8px;opacity:.7}
.ib p{color:var(--g5);font-size:.83rem}
.ii{margin-top:12px;background:rgba(52,211,153,.06);border-radius:8px;padding:11px;font-size:.78rem;color:var(--grn);border:1px solid rgba(52,211,153,.14)}
.ii ul{margin-top:5px;padding-left:16px}
.ipv{margin-top:12px;font-size:.74rem;color:var(--g7);background:var(--s2);border-radius:7px;padding:10px;max-height:110px;overflow-y:auto;border:1px solid var(--g2);box-shadow:inset 0 2px 4px rgba(0,0,0,.2)}
.wb{margin-top:12px;padding:10px 14px;background:rgba(245,158,11,.06);border-radius:8px;font-size:.76rem;color:var(--gold);border-left:3px solid rgba(245,158,11,.35)}
.cmr{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:12px}
.cmrow{display:flex;align-items:center;gap:6px;font-size:.78rem;background:var(--s2);padding:6px 10px;border-radius:7px;border:1px solid var(--g2)}
.cmrow.cmrow-ok{background:rgba(52,211,153,.06);border-color:rgba(52,211,153,.18)}
.cmrow span{color:var(--g5);min-width:130px;font-size:.73rem}
.cmrow select{flex:1;padding:3px 7px;font-size:.76rem}
.dr{display:flex;gap:8px;margin-bottom:8px;font-size:.82rem}
.dr .lb{font-weight:700;color:var(--bm);min-width:130px;font-size:.72rem;text-transform:uppercase;padding-top:1px;letter-spacing:.05em;opacity:.8}
.dr .vl{color:var(--g9);flex:1}

.toast{position:fixed;bottom:20px;right:20px;padding:12px 18px;border-radius:10px;font-size:.8rem;font-weight:600;box-shadow:0 12px 40px rgba(0,0,0,.5),0 0 0 1px rgba(255,255,255,.07);z-index:2000;display:none;color:#fff;max-width:360px;animation:su .3s cubic-bezier(.34,1.4,.64,1);backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,.1)}
.toast.show{display:block}
@keyframes su{from{transform:translateY(20px) scale(.9);opacity:0}to{transform:translateY(0) scale(1);opacity:1}}
.loading{text-align:center;padding:40px;color:var(--bm);background:var(--s1);font-size:.88rem}
.spin{display:inline-block;width:22px;height:22px;border:2px solid rgba(6,182,212,.15);border-top-color:var(--bm);border-radius:50%;animation:spin .75s linear infinite;margin-right:8px;vertical-align:middle}
@keyframes spin{to{transform:rotate(360deg)}}
.empty{text-align:center;padding:60px 20px;color:var(--g5);background:var(--s1)}
...
.hlog-item:hover{background:rgba(6,182,212,.04)}
.hlog-dt{padding:10px 14px;color:var(--g5);white-space:nowrap;font-size:.71rem;border-right:1px solid var(--g2)}
...
.hlog-det strong{color:var(--bm)}
.field-chg{display:inline-block;background:rgba(245,158,11,.07);border:1px solid rgba(245,158,11,.18);border-radius:4px;padding:1px 7px;margin:2px 3px 2px 0;font-size:.7rem}
.field-chg .old{color:var(--red);text-decoration:line-through;margin-right:4px;opacity:.75}
.field-chg .new{color:var(--grn)}
.hlog-ip{font-size:.67rem;color:var(--g5);margin-top:3px;opacity:.55}
...
.hist-toolbar{display:flex;gap:8px;align-items:center;padding:10px 16px;background:var(--s1);border-bottom:1px solid var(--g2);flex-wrap:wrap}
.hist-toolbar select{width:auto;padding:5px 8px;font-size:.76rem}
.col-toggle-label{display:flex;align-items:center;gap:10px;cursor:pointer;font-size:.84rem;padding:7px 11px;border-radius:7px;background:var(--s2);border:1px solid var(--g2)}
.col-toggle-label:hover{background:rgba(6,182,212,.05);border-color:rgba(6,182,212,.18)}

.fb-badge{display:inline-flex;align-items:center;gap:5px;background:rgba(245,158,11,.07);border:1px solid rgba(245,158,11,.18);border-radius:12px;padding:2px 10px;font-size:.63rem;font-weight:700;color:rgba(245,158,11,.8);box-shadow:0 0 10px rgba(245,158,11,.05)}
.fb-dot{width:6px;height:6px;border-radius:50%;display:inline-block}

.ac-progress-wrap{background:linear-gradient(90deg,#060D18,#0A1525);padding:0;overflow:hidden;height:0;transition:height .25s ease;border-bottom:1px solid var(--g2)}
.ac-progress-wrap.active{height:36px}
.ac-progress-inner{display:flex;align-items:center;gap:12px;padding:0 24px;height:36px}
.ac-progress-label{font-size:.7rem;color:var(--bm);font-weight:600;white-space:nowrap;min-width:220px;letter-spacing:.02em}
.ac-progress-bar-bg{flex:1;background:rgba(255,255,255,.05);border-radius:20px;height:4px;overflow:hidden;box-shadow:inset 0 1px 3px rgba(0,0,0,.4)}
.ac-progress-bar-fill{height:100%;background:linear-gradient(90deg,#06B6D4,#22D3EE,#06B6D4);border-radius:20px;transition:width .3s ease;box-shadow:0 0 12px rgba(6,182,212,.6)}
...
.ac-progress-pct{font-size:.7rem;color:var(--bm);font-weight:700;min-width:38px;text-align:right}

.dec-wrap{background:var(--s1);padding:0 0 16px;border-top:1px solid var(--g2)}
.dec-section-title{background:linear-gradient(90deg,rgba(6,182,212,.07) 0%,transparent 100%);padding:8px 14px;border:none;display:flex;align-items:center;gap:8px;justify-content:space-between;border-bottom:1px solid var(--g2)}
.dec-section-label{font-size:.72rem;font-weight:700;color:var(--bm);letter-spacing:.08em;text-transform:uppercase}
.dec-section-sub{font-size:.63rem;color:var(--g5)}
.dec-inner{padding:10px 16px 0}
.dec-card{background:var(--s2);border-radius:12px;border:1px solid var(--g2);box-shadow:var(--sh-card);overflow:hidden;transition:box-shadow .2s,border-color .2s}
.dec-card:hover{box-shadow:var(--sh-card-hover);border-color:rgba(6,182,212,.1)}
.dec-top{display:flex;align-items:center;gap:8px;padding:8px 12px;flex-wrap:wrap;background:linear-gradient(135deg,rgba(6,182,212,.07),rgba(6,182,212,.03));border-bottom:1px solid rgba(6,182,212,.08)}
.dec-label{display:flex;align-items:center;gap:4px;flex-shrink:0}
.dec-tag{font-family:'JetBrains Mono','Courier New',monospace;font-size:.58rem;color:var(--bm);border:1px solid rgba(6,182,212,.22);padding:1px 6px;border-radius:3px;letter-spacing:.1em;white-space:nowrap;background:rgba(6,182,212,.06)}
.dec-title{font-size:.72rem;font-weight:700;color:var(--g9);white-space:nowrap;letter-spacing:.02em}
.dec-title span{color:var(--bm)}
.dec-search{display:flex;gap:5px;flex:1;min-width:150px}
.dec-input{flex:1;background:rgba(0,0,0,.3);border:1px solid var(--g3);border-radius:7px;color:var(--bm);font-family:'JetBrains Mono','Courier New',monospace;font-size:.72rem;padding:6px 10px;letter-spacing:.06em;outline:none;transition:all .2s;min-width:0;box-shadow:inset 0 2px 6px rgba(0,0,0,.3)}
.dec-input:focus{border-color:var(--bm);background:rgba(6,182,212,.05);box-shadow:0 0 0 2px rgba(6,182,212,.2),inset 0 1px 4px rgba(0,0,0,.2)}
.dec-input::placeholder{color:rgba(255,255,255,.18);font-size:.63rem}
.dec-btn{background:linear-gradient(180deg,#22D3EE 0%,#06B6D4 50%,#0891B2 100%);color:#041720;border:none;border-radius:7px;font-family:'JetBrains Mono','Courier New',monospace;font-size:.63rem;font-weight:700;padding:6px 12px;cursor:pointer;letter-spacing:.06em;transition:all .2s;white-space:nowrap;box-shadow:var(--sh-btn-sm),0 0 12px rgba(6,182,212,.2);border-top:1px solid rgba(255,255,255,.2)}
.dec-btn:hover{background:linear-gradient(180deg,#38E8FF 0%,#22D3EE 100%);box-shadow:0 4px 16px rgba(6,182,212,.4);transform:translateY(-1px)}
...
.dec-code{font-family:'JetBrains Mono','Courier New',monospace;font-size:.9rem;font-weight:800;color:var(--bm);text-shadow:0 0 16px rgba(6,182,212,.35)}
...
.dec-row{display:flex;gap:4px;padding:4px 8px;background:rgba(255,255,255,.023);border-radius:5px;align-items:flex-start;border:1px solid rgba(255,255,255,.04);font-size:.7rem;transition:background .12s,border-color .12s}
.dec-row:hover{background:rgba(6,182,212,.05);border-color:rgba(6,182,212,.1)}
.dec-key{font-family:'JetBrains Mono','Courier New',monospace;font-size:.53rem;color:var(--g5);letter-spacing:.09em;white-space:nowrap;min-width:58px;padding-top:1px;text-transform:uppercase}
.dec-val{font-size:.7rem;color:var(--g9);font-weight:600;line-height:1.3}
.dec-badge{display:inline-block;font-family:'JetBrains Mono','Courier New',monospace;font-size:.6rem;padding:1px 7px;border-radius:4px;letter-spacing:.05em;font-weight:700;box-shadow:0 1px 4px rgba(0,0,0,.3)}
.badge-oem{background:rgba(6,182,212,.1);color:var(--bm);border:1px solid rgba(6,182,212,.2)}
.badge-after{background:rgba(52,211,153,.07);color:var(--grn);border:1px solid rgba(52,211,153,.18)}
.badge-medida{background:rgba(245,158,11,.07);color:var(--gold);border:1px solid rgba(245,158,11,.18)}
.badge-ref{background:rgba(167,139,250,.07);color:#A78BFA;border:1px solid rgba(167,139,250,.18)}
.badge-unknown{background:rgba(248,113,113,.07);color:var(--red);border:1px solid rgba(248,113,113,.18)}
.hl-blue{color:var(--bm);font-weight:700}
.hl-green{color:var(--grn);font-weight:700}
.hl-amber{color:var(--gold);font-weight:700}

.dec-anatomy{background:rgba(6,182,212,.04);border:1px solid rgba(6,182,212,.1);border-radius:8px;padding:8px 10px 10px;box-shadow:0 0 16px rgba(6,182,212,.04)}
.dec-anat-title{font-size:.57rem;font-weight:700;color:var(--bm);letter-spacing:.1em;margin-bottom:6px;text-align:center;text-transform:uppercase;opacity:.75}
.dec-anat-title span{color:#38E8FF;font-family:'JetBrains Mono',monospace}
...
.dec-seg-box{font-family:'JetBrains Mono','Courier New',monospace;font-size:.84rem;font-weight:800;padding:3px 6px;border-radius:5px;border:1px solid transparent;width:100%;text-align:center;box-shadow:0 2px 8px rgba(0,0,0,.3),inset 0 1px 0 rgba(255,255,255,.08)}
.seg-blue{color:#38BDF8;background:rgba(56,189,248,.1);border-color:rgba(56,189,248,.25)}
.seg-green{color:#34D399;background:rgba(52,211,153,.1);border-color:rgba(52,211,153,.25)}
.seg-amber{color:#FCD34D;background:rgba(252,211,77,.08);border-color:rgba(252,211,77,.2)}
.seg-purple{color:#C084FC;background:rgba(192,132,252,.08);border-color:rgba(192,132,252,.2)}
.dec-seg-line{width:1px;height:4px;background:rgba(255,255,255,.07)}
.dec-seg-label{font-size:.52rem;font-weight:700;text-align:center;line-height:1.2;padding:0 1px;margin-top:1px}
.lbl-blue{color:#38BDF8}.lbl-green{color:#34D399}.lbl-amber{color:#FCD34D}.lbl-purple{color:#C084FC}
.dec-seg-sub-line{width:1px;height:3px;background:rgba(255,255,255,.04);margin-top:1px}
.dec-seg-sub{font-size:.47rem;color:var(--g5);text-align:center;line-height:1.1;padding:0 1px}
.dec-sep{font-family:'JetBrains Mono','Courier New',monospace;font-size:.84rem;color:rgba(255,255,255,.12);font-weight:700;padding:0 1px;align-self:center;flex:0;min-width:auto}

.dec-notfound{font-size:.72rem;color:var(--red);margin-top:4px;padding:6px 10px;background:rgba(248,113,113,.06);border-radius:6px;border:1px solid rgba(248,113,113,.14);display:none}
.dec-notfound.visible{display:block}
.dec-suggest{margin-top:4px;padding:6px 10px;background:rgba(255,255,255,.02);border-radius:6px;border:1px solid var(--g2);display:none}
.dec-suggest-title{font-family:'JetBrains Mono',monospace;font-size:.57rem;color:var(--g5);letter-spacing:.1em;margin-bottom:4px;text-transform:uppercase}
.dec-suggest-list{display:flex;flex-wrap:wrap;gap:4px}
.dec-chip{background:rgba(6,182,212,.06);border:1px solid rgba(6,182,212,.16);border-radius:5px;font-family:'JetBrains Mono','Courier New',monospace;font-size:.63rem;color:var(--bm);padding:3px 8px;cursor:pointer;transition:all .15s;box-shadow:0 1px 4px rgba(0,0,0,.3);touch-action:manipulation}
.dec-chip:hover{border-color:var(--bm);background:rgba(6,182,212,.12);box-shadow:0 4px 12px rgba(6,182,212,.2);transform:translateY(-1px)}
.dec-chip:active{transform:translateY(1px)}

.dec-comp-toggle{display:flex;align-items:center;gap:4px;margin-top:4px;padding:5px 10px;background:rgba(255,255,255,.02);border:1px solid var(--g2);border-radius:6px;cursor:pointer;font-family:'JetBrains Mono','Courier New',monospace;font-size:.57rem;color:var(--g5);letter-spacing:.1em;text-transform:uppercase;transition:all .15s;width:100%;text-align:left;touch-action:manipulation}
.dec-comp-toggle:hover{border-color:rgba(6,182,212,.2);color:var(--bm);background:rgba(6,182,212,.04);transform:translateY(-1px)}
...
.dec-comparador{margin-top:4px;background:rgba(6,182,212,.03);border:1px solid rgba(6,182,212,.08);border-radius:8px;padding:8px 10px;display:none}
...
.dec-comp-vs{font-family:'JetBrains Mono',monospace;font-size:.62rem;color:var(--g5);text-align:center;font-weight:700}
.dec-comp-input{background:rgba(0,0,0,.3);border:1px solid var(--g3);border-radius:5px;color:var(--g9);font-family:'JetBrains Mono','Courier New',monospace;font-size:.72rem;padding:4px 8px;outline:none;transition:all .2s;width:100%;box-sizing:border-box;letter-spacing:.04em;box-shadow:inset 0 2px 6px rgba(0,0,0,.3)}
.dec-comp-input:focus{border-color:var(--bm);box-shadow:0 0 0 2px rgba(6,182,212,.15),inset 0 1px 3px rgba(0,0,0,.2)}
.dec-comp-btn{width:100%;margin-bottom:4px;background:linear-gradient(180deg,#22D3EE 0%,#06B6D4 50%,#0891B2 100%);border:none;border-radius:5px;color:#041720;font-family:'JetBrains Mono','Courier New',monospace;font-size:.62rem;font-weight:700;padding:5px 10px;cursor:pointer;letter-spacing:.06em;transition:all .15s;box-shadow:var(--sh-btn-sm);border-top:1px solid rgba(255,255,255,.18);touch-action:manipulation}
.dec-comp-btn:hover{background:linear-gradient(180deg,#38E8FF 0%,#22D3EE 100%);box-shadow:0 4px 16px rgba(6,182,212,.35);transform:translateY(-1px)}
...
.dec-verdict{text-align:center;padding:4px 10px;border-radius:6px;font-family:'JetBrains Mono','Courier New',monospace;font-size:.62rem;font-weight:700;letter-spacing:.06em;margin-bottom:4px}
.vrd-ok{background:rgba(52,211,153,.1);color:var(--grn);border:1px solid rgba(52,211,153,.18)}
.vrd-mir{background:rgba(6,182,212,.08);color:var(--bm);border:1px solid rgba(6,182,212,.14)}
.vrd-sim{background:rgba(245,158,11,.07);color:var(--gold);border:1px solid rgba(245,158,11,.14)}
.vrd-diff{background:rgba(248,113,113,.07);color:var(--red);border:1px solid rgba(248,113,113,.14)}
.dec-cmp-row{display:grid;grid-template-columns:50px 1fr 1fr;gap:2px;margin-bottom:2px;align-items:start}
.dec-cmp-lbl{font-family:'JetBrains Mono','Courier New',monospace;font-size:.55rem;color:var(--g5);letter-spacing:.09em;padding-top:2px;text-transform:uppercase}
.dec-cmp-cell{font-size:.7rem;padding:2px 6px;border-radius:4px;line-height:1.4;border:1px solid transparent}
.ccell-match{background:rgba(52,211,153,.08);color:var(--grn);border-color:rgba(52,211,153,.14)}
.ccell-mir{background:rgba(6,182,212,.07);color:var(--bm);border-color:rgba(6,182,212,.12)}
.ccell-diff{background:rgba(248,113,113,.07);color:var(--red);border-color:rgba(248,113,113,.12)}
.ccell-na{background:rgba(255,255,255,.02);color:var(--g5);font-style:italic}

.dec-db-bar{display:flex;align-items:center;gap:6px;margin-top:4px;padding:6px 10px;background:rgba(255,255,255,.02);border-top:1px solid var(--g2);flex-wrap:wrap}
.dec-db-label{font-family:'JetBrains Mono','Courier New',monospace;font-size:.57rem;color:var(--g5);letter-spacing:.07em;flex:1}
.dec-db-label span{color:var(--bm);font-weight:700}
.dec-db-btn{background:rgba(6,182,212,.06);color:var(--bm);border:1px solid rgba(6,182,212,.16);border-radius:5px;font-family:'JetBrains Mono','Courier New',monospace;font-size:.6rem;font-weight:700;padding:3px 10px;cursor:pointer;letter-spacing:.05em;transition:all .15s;white-space:nowrap;box-shadow:0 1px 4px rgba(0,0,0,.3);touch-action:manipulation}
.dec-db-btn:hover{border-color:var(--bm);background:rgba(6,182,212,.12);box-shadow:0 4px 12px rgba(6,182,212,.2);transform:translateY(-1px)}
.dec-db-btn:active{transform:translateY(1px)}
.dec-db-status{font-family:'JetBrains Mono','Courier New',monospace;font-size:.57rem;color:var(--g5);padding:0 8px 2px;min-height:12px;transition:color .3s}
.dec-db-status.ok{color:var(--grn)}.dec-db-status.err{color:var(--red)}

@media(max-width:900px){.ac-header{padding:0 16px;min-height:54px}.ac-htitle .s2{font-size:.88rem}.ac-fg{grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:8px}.dec-two{grid-template-columns:1fr}.dec-grid{grid-template-columns:1fr 1fr}}
@media(max-width:768px){.ac-header{padding:7px 14px;min-height:auto;gap:6px}.ac-hl{gap:8px;flex-wrap:wrap}.ac-htitle .s2{font-size:.84rem}.ac-htitle .s1{display:none}.ac-badge{display:none}.fb-badge{font-size:.6rem;padding:2px 7px}.ac-hact{gap:5px;flex-wrap:wrap}.btn{padding:8px 13px;font-size:.76rem;border-radius:7px;min-height:38px}.ac-sp{padding:10px 14px}.ac-fg{grid-template-columns:1fr 1fr;gap:8px}.ac-sr{flex-direction:column;gap:7px}.ac-sr .ac-fl{min-width:0}.ac-sb{padding:5px 14px;gap:8px;font-size:.7rem}.ac-qs{padding:7px 14px;gap:8px}.ac-qi{padding:5px 12px;border-radius:8px}.ac-qi .n{font-size:.95rem}.ac-tw{max-height:calc(100vh - 250px);-webkit-overflow-scrolling:touch}table{font-size:.75rem}thead th{padding:8px 9px;font-size:.62rem}tbody td{padding:6px 9px}.ac-pg{padding:8px 14px;gap:4px}.pb{padding:6px 10px;font-size:.72rem;min-height:34px}.pi{display:none}.md{width:96vw!important;max-width:96vw!important;border-radius:14px;max-height:92vh}.fgrid{grid-template-columns:1fr}.cmr{grid-template-columns:1fr}.hlog-item{grid-template-columns:1fr;border-bottom:2px solid var(--g2)}.hlog-dt,.hlog-op{border-right:none;border-bottom:1px solid var(--g2)}.mhist-wrap{max-height:55vh}.mf{flex-wrap:wrap;gap:6px}.mf .btn{flex:1;min-width:100px;justify-content:center;display:flex}.dec-inner{padding:7px 10px 0}.dec-two{grid-template-columns:1fr;gap:10px}.dec-grid{grid-template-columns:1fr}.btn-copy{padding:2px 6px;font-size:.63rem}}
@media(max-width:480px){.ac-header{padding:6px 12px}.ac-fg{grid-template-columns:1fr}.ac-hact .btn-c:not(:first-child):not(:nth-child(2)){display:none}.ac-tw{max-height:calc(100vh - 230px)}thead th{padding:7px 7px;font-size:.6rem;letter-spacing:.4px}tbody td{padding:5px 7px;font-size:.72rem}.ac-qi{padding:4px 10px}select,input[type=text]{padding:10px 11px;font-size:.86rem}.btn{padding:9px 12px;font-size:.78rem;min-height:42px}.pb{padding:7px 10px;font-size:.74rem}.ac-pg{gap:3px;padding:6px 12px}.toast{bottom:12px;right:12px;left:12px;max-width:100%}.dec-seg-box{font-size:.72rem;padding:2px 4px}.dec-anatomy{padding:6px 8px}}
`;
