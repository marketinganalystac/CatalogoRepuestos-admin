...
function LoginScreen() {
  ...
  return (
    <div style={{
      ...
      background:'linear-gradient(135deg, #1A3F6F 0%, #0060A0 55%, #15335c 100%)',
      ...
      <style>{`
        ...
        .ac-login-card{
          ...
          box-shadow:0 20px 50px rgba(16,32,56,.18),0 2px 8px rgba(16,32,56,.08);
...
.ac-progress-spin{width:38px;height:38px;border:2.5px solid rgba(255,255,255,.15);border-top-color:var(--gold);
  border-radius:50%;margin:0 auto 22px;animation:spin .8s linear infinite}
@keyframes spin{to{transform:rotate(360deg)}}
.ac-progress-pct{
  ...
  return (
    ...
    <>
      ...
      {/* BARRA DE PROGRESO GLOBAL — pantalla emergente a pantalla completa.
          ...
          El video nunca se detiene (loop) mientras la barra avanza hasta el 100%. */}
