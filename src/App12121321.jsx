...
function LoginScreen() {
  ...
  return (
    <div style={{
      ...
      `}</style>
      {/* Contenedor externo: ancla en el mismo punto al wrapper del video y al card, sin unirlos */}
      <div className="ac-login-outer">
        {/* Wrapper del video — tamaño y offset originales intactos */}
