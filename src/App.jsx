              ...
              <div style={{position:'relative'}}>
                ...
                <button type="button" onClick={()=>setShowPw(p=>!p)}
                  style={{position:'absolute',right:10,top:'50%',transform:'translateY(-50%)',
                    background:'none',border:'none',cursor:'pointer',color:'#90A4AE',fontSize:'0.72rem'}}>
                  {showPw?'🙈':'👁'}
                </button>
              </div>
            </div>
...
function CatalogoApp() {
  ...
  useEffect(()=>{
    (async()=>{
      try {
        setLoading(true);
        setLoadProgress({ active:true, pct:0, msg:'', indeterminate:true });
    ...
    <>
      ...
      <div className={`ac-progress-overlay${loadProgress.active?' active':''}`}>
        <div className="ac-progress-card">
          ...
          <div className="ac-progress-title">Cargando catálogo</div>
