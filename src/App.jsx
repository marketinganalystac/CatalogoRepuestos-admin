...
.ac-progress-card{
  ...
  padding:48px 56px;width:50vw;height:50vh;max-width:900px;min-width:340px;
  display:flex;flex-direction:column;align-items:center;justify-content:center;
  text-align:center;
  box-shadow:0 24px 60px rgba(0,0,0,.45),0 0 80px rgba(0,96,160,.15);
}
.ac-progress-video-wrap{position:relative;width:260px;max-width:70%;margin-bottom:22px;display:block;line-height:0}
.ac-progress-video{width:100%;height:auto;border-radius:12px;display:block}
.ac-progress-video-wrap .ac-progress-bar-bg{
  position:absolute;left:8%;right:8%;bottom:10px;width:auto;
...
@keyframes spin{to{transform:rotate(360deg)}}
.ac-progress-label{font-size:0.82rem;color:rgba(255,255,255,.92);font-weight:600;overflow:hidden;text-overflow:ellipsis;display:block;margin-bottom:20px;max-width:100%}
.ac-progress-bar-bg{width:100%;background:rgba(255,255,255,.14);border-radius:24px;height:22px;overflow:hidden;box-shadow:inset 0 1px 3px rgba(0,0,0,.25)}
.ac-progress-bar-fill{height:100%;background:linear-gradient(90deg,#f0c000,var(--gold),#f5ca00);border-radius:24px;transition:width .3s ease;box-shadow:0 0 8px rgba(212,168,0,.5)}
...
.ac-progress-pct{display:block;margin-top:14px;font-size:0.75rem;color:var(--gold);font-weight:700;text-shadow:0 1px 3px rgba(0,0,0,.3)}
  ...
  return (
    ...
    <>
      ...
      {/* BARRA DE PROGRESO GLOBAL — pantalla emergente a pantalla completa.
          El video y la barra están dentro del mismo contenedor (wrap) para que
          la barra se sobreponga sobre el video y se vean como un solo elemento.
