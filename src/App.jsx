  ...
  return (
    <div className="mo show">
      <div className="md sm">
        <div className="mh">
          <div>
            <h2 style={{display:'flex',alignItems:'center',gap:8,marginBottom:2}}><Icon.Search/>Detalle del Registro</h2>
            {record.fields[4] && (
              <div style={{display:'flex',alignItems:'center',gap:8,marginTop:2}}>
                <span style={{fontSize:'0.72rem',color:'var(--g6)',fontWeight:600}}>{record.fields[4]}</span>
                <VerifBadge
        ...
        <div className="mb">
          ...
          {/* Equivalencia — nuevo campo, por el momento se mantiene vacío */}
          <div className="dr">
            <span className="lb">Equivalencia</span><span className="vl" style={{color:'var(--g5)'}}>—</span>
          </div>

          {reporting && (
            <div style={{marginTop:14,padding:12,borderRadius:8,background:'var(--g1)',border:'1px solid var(--g3)'}}>
