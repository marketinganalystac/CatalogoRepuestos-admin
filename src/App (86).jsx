...
.ac-progress-overlay{
  ...
  display:flex;align-items:center;justify-content:center;
  background:linear-gradient(135deg, rgba(71,76,84,.82) 0%, rgba(55,59,66,.82) 55%, rgba(38,41,46,.82) 100%);
  opacity:0;pointer-events:none;transition:opacity .25s ease;
}
.ac-progress-overlay.active{opacity:1;pointer-events:all}
.ac-progress-card{
  background:linear-gradient(135deg, rgba(71,76,84,.50) 0%, rgba(55,59,66,.50) 55%, rgba(38,41,46,.50) 100%);
  border:none;border-radius:0;
...
.ac-progress-spin{width:44px;height:44px;border:3px solid rgba(255,255,255,.2);border-top-color:var(--gold);
...
.ac-progress-bar-bg::before{
  content:'';position:absolute;left:-40px;right:-40px;top:-60px;height:60px;
  background:linear-gradient(180deg,rgba(38,41,46,0) 0%,rgba(38,41,46,.75) 70%,rgba(38,41,46,.95) 100%);
