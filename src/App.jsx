...
.ac-progress-card{
  ...
  padding:36px 44px 40px;width:42vw;max-width:480px;min-width:340px;
...
.ac-progress-video-wrap::after{
  ...
  box-shadow:inset 0 0 55px 26px rgba(13,32,64,.85);
  border-radius:18px;
}
...
@keyframes spin{to{transform:rotate(360deg)}}
.ac-progress-pct{
  font-size:2.3rem;font-weight:800;color:var(--gold);line-height:1;
  text-shadow:0 2px 8px rgba(0,0,0,.4);margin-bottom:12px;letter-spacing:.5px;
}
...
.ac-progress-bar-bg{width:68%;background:rgba(0,0,0,.35);border-radius:20px;height:9px;overflow:hidden;position:relative;box-shadow:inset 0 1px 3px rgba(0,0,0,.3)}
  ...
  return (
    ...
    <>
      ...
      {/* BARRA DE PROGRESO GLOBAL — pantalla emergente a pantalla completa.
          ...
          con la tarjeta. El % es grande y va arriba de la barra, que ahora es
          más delgada. El video nunca se detiene (loop) mientras la barra
          avanza hasta el 100%. */}
