...
.dtl-item-ic{width:30px;height:30px;border-radius:9px;background:var(--bl);color:var(--bm);display:flex;align-items:center;justify-content:center;flex-shrink:0}
.dtl-item-ic svg{width:18px;height:18px}
.dtl-item-ic.mini{width:22px;height:22px;border-radius:7px}
.dtl-item-ic.mini svg{width:14px;height:14px}
...
.dtl-code-chip button svg{width:16px;height:16px}
...
.novf-chev{display:inline-block;font-size:1.6rem;font-weight:800;line-height:1;transition:transform .2s ease;flex-shrink:0}
...
const ModalDetail = ({ record, onClose, onEdit, onReported, onVerified }) => {
  ...
  // Si el split de códigos tiene más de 2 elementos, el primero (el
  // combinado "Código Repuesto") queda redundante — no se muestra.
  const codigosListaVisible = codigosLista.length > 2
    ? codigosLista.slice(1)
    : codigosLista;
          ...
          return (<>
            ...
            <div className="ac-fg2 ac-fg2-primary">
              ...
              {novedadDisplay && (()=>{
                ...
                return (
                  <div className="novf-inline-wrap" key={codLine||vehiculo} style={{gridColumn:'3 / span 2', position:'relative'}}>
