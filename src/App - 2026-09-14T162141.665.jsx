...
.novf-chev-btn{display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;border-radius:5px;flex-shrink:0;transition:background-color .12s ease}
.novf-chev-btn:hover{background:rgba(255,255,255,.18)}
.novf-chev{display:inline-block;font-size:1.05rem;font-weight:700;transition:transform .2s ease;flex-shrink:0}
...
const VerifBadge = ({ count, threshold, yaVerifique, loading, onClick, size = 26 }) => {
  ...
  const title = check2
    ...
    : yaVerifique
      ...
      : `Confirmar que este código es correcto (${count}/${threshold})`;
          ...
          <div className="dtl-hleft">
            ...
            <div className="dtl-verif-wrap">
              ...
              <span className={`dtl-verif-bubble${estaVerificado?'':' gray'}`}>
                {estaVerificado ? 'Verificado' : 'Verificando'}
              </span>
            </div>
          </div>
          <button className="mx" onClick={onClose}>×</button>
                ...
                return (
                  <div className="novf-inline-wrap" key={codLine||vehiculo} style={{gridColumn:'3 / span 2'}}>
                    <div className={`novf-pill novf-pill-rise${novedadHidden?' novf-hide':''}`} onClick={goToNovedad} title="Ver este registro en la tabla">
                      ...
                      <Icon.X onClick={e=>{e.stopPropagation();dismissNovedad();}} style={{width:11,height:11,opacity:.75,marginLeft:1}} title="Descartar"/>
