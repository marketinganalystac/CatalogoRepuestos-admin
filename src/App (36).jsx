...
.ac-fg2-primary select{border-color:var(--bm);font-weight:700}
.ac-fg2-primary .ac-fl label{color:var(--bd);font-weight:800}

/* Panel de ícono — ocupa el espacio donde antes estaban Clasificación/Subclasificación,
   ahora un ícono SVG opaco condicionado a la Clasificación seleccionada */
.ac-clasi-icon-panel{
  display:flex;align-items:center;justify-content:center;gap:10px;
  grid-column:1/-1;padding:10px 14px;margin-bottom:10px;
  border:1.5px dashed var(--g3);border-radius:9px;
  background:var(--g1);color:var(--bm);
}
.ac-clasi-icon-panel svg{opacity:.22;flex-shrink:0}
.ac-clasi-icon-label{font-size:0.62rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;opacity:.55}
...
@media(max-width:768px){
  ...
  .ac-clasi-icon-panel{padding:8px 10px}
    ...
    <>
      ...
      <div className="ac-sp">
        {(() => {
          ...
          return (<>
            {/* Selección principal: Clasificación / Subclasificación */}
            ...
            {/* Marca / Modelo — quedan debajo de Clasificación / Subclasificación */}
            <div className="ac-fg2">
            ...
            {/* Espacio donde antes estaban Clasificación/Subclasificación:
                ahora un ícono SVG opaco condicionado por la Clasificación activa */}
