...
.ac-progress-label{font-size:0.74rem;color:rgba(255,255,255,.6);font-weight:500;overflow:hidden;text-overflow:ellipsis;
  display:block;margin-top:10px;max-width:320px;white-space:nowrap}
...
const VerifBadge = ({ count, threshold, yaVerifique, loading, onClick, size = 26 }) => {
  ...
  return (
    ...
    >
      ...
      {/* palomita 2 */}
      <path d="M10.1 14.6l2.6 2.6 6.4-8.4" fill="none" stroke={check2?bright:dim} strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter"/>
    </svg>
  );
};
...
const MiniVerifBadge = ({ size = 18, title = `Verificado por ${VERIF_THRESHOLD}+ usuarios` }) => (
  <svg width={size} height={size} viewBox="0 0 26 26" title={title} style={{flexShrink:0}}>
    ...
    <path d="M10.1 14.6l2.6 2.6 6.4-8.4" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter"/>
  </svg>
);
