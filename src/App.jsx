...
.ac-clasi-icon-panel img.ac-clasi-img{
  opacity:.28;flex-shrink:0;max-width:260px;max-height:100%;
  object-fit:contain;-webkit-mask-image:linear-gradient(to left,black 40%,transparent 100%);
...
@media(max-width:768px){
  ...
  .ac-clasi-icon-panel img.ac-clasi-img{max-width:120px}
