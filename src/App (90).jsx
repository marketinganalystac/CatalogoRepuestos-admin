...
══════════════════════════════════ */
.btn{
  padding:8px 16px;border:none;border-radius:10px;font-size:0.67rem;font-weight:700;
...
.btn-p:hover{
  background:linear-gradient(180deg,#4E9CF0 0%,#1E7FDB 50%,#0B63C4 100%);
  box-shadow:var(--sh-hover),0 0 0 1px rgba(0,64,128,.5);
  transform:translateY(-1px);
}
.btn-p:active{background:linear-gradient(180deg,#084C99 0%,var(--bm) 100%);box-shadow:var(--sh-active);transform:translateY(1px)}
...
.btn-g:hover{background:linear-gradient(180deg,#FCD34D 0%,#D97706 50%,#92400E 100%);box-shadow:var(--sh-hover);transform:translateY(-1px)}
.btn-g:active{background:linear-gradient(180deg,#B45309 0%,#d4a800 100%);box-shadow:var(--sh-active);transform:translateY(1px)}
...
.btn-o:hover{background:linear-gradient(180deg,var(--bl) 0%,#D3E9FB 100%);border-color:var(--bm);box-shadow:0 4px 12px rgba(0,96,160,.18);transform:translateY(-1px)}
.btn-o:active{background:var(--bl);transform:translateY(1px);box-shadow:inset 0 2px 4px rgba(0,96,160,.15)}

/* Dark */
.btn-dark{
  background:linear-gradient(180deg,#0F3358 0%,var(--bd) 50%,#071C30 100%);
  color:#fff;border:none;
  box-shadow:var(--sh-btn);border-top:1px solid rgba(255,255,255,.18);
}
.btn-dark:hover{background:linear-gradient(180deg,#153A5E 0%,#0C2C4A 100%);box-shadow:var(--sh-hover);transform:translateY(-1px)}
...
.btn-sm{padding:4px 10px;font-size:0.59rem;border-radius:8px}
