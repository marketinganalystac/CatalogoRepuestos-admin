...
function LoginScreen() {
  ...
  return (
    <div style={{
      ...
      background:'linear-gradient(135deg, #111827 0%, #0E7C86 55%, #0B1220 100%)',
      ...
      <div className="ac-login-outer">
        ...
        {/* Header */}
        <div style={{background:'linear-gradient(135deg,#111827,#0E7C86)',padding:'28px 32px 22px',
        ...
        <div style={{padding:'28px 32px 32px'}}>
          ...
          <form onSubmit={handleLogin} style={{display:'flex',flexDirection:'column',gap:14}}>
            <div style={{display:'flex',flexDirection:'column',gap:4}}>
              <label style={{fontSize:'0.55rem',color:'#0E7C86',fontWeight:700,textTransform:'uppercase',letterSpacing:.6}}>
                Correo electrónico
              </label>
            ...
            <button type="submit" disabled={loading}
              style={{marginTop:4,background:'#0E7C86',color:'#fff',border:'none',borderRadius:8,
...
function ToastProvider({ children }) {
  ...
  const bgMap = { success:'#2E7D32', error:'#C62828', info:'#0E7C86', warning:'#D84315' };
...
const STYLES = `
:root{
  --bd:#111827;--bm:#0E7C86;--bl:#E3FBFC;--gold:#F59E0B;--gl:#FFF3DC;
...
══════════════════════════════════ */
.ac-header{
  background:linear-gradient(135deg,var(--bd) 0%,#0B1220 100%);
...
.btn-p{
  background:linear-gradient(180deg,#14B8C4 0%,var(--bm) 50%,#0B5D66 100%);
  color:#fff;
  box-shadow:var(--sh-btn),0 0 0 1px rgba(0,64,128,.4);
  border-top:1px solid rgba(255,255,255,.22);
}
.btn-p:hover{
  background:linear-gradient(180deg,#22C3D1 0%,#17A6B3 50%,#0E7C86 100%);
  box-shadow:var(--sh-hover),0 0 0 1px rgba(0,64,128,.5);
  transform:translateY(-1px);
}
.btn-p:active{background:linear-gradient(180deg,#0B5D66 0%,var(--bm) 100%);box-shadow:var(--sh-active);transform:translateY(1px)}
...
.btn-o:hover{background:linear-gradient(180deg,var(--bl) 0%,#CFF7F9 100%);border-color:var(--bm);box-shadow:0 4px 12px rgba(0,96,160,.18);transform:translateY(-1px)}
.btn-o:active{background:var(--bl);transform:translateY(1px);box-shadow:inset 0 2px 4px rgba(0,96,160,.15)}

/* Dark */
.btn-dark{
  background:linear-gradient(180deg,#17202E 0%,var(--bd) 50%,#0A1018 100%);
  color:#fff;border:none;
  box-shadow:var(--sh-btn);border-top:1px solid rgba(255,255,255,.18);
}
.btn-dark:hover{background:linear-gradient(180deg,#1E2A3D 0%,#141C29 100%);box-shadow:var(--sh-hover);transform:translateY(-1px)}
...
.btn-edit{
  padding:4px 10px;
  background:linear-gradient(180deg,#14B8C4 0%,var(--bm) 100%);
...
.btn-edit:hover{background:linear-gradient(180deg,#22C3D1 0%,#0E7C86 100%);box-shadow:var(--sh-hover);transform:translateY(-1px)}
...
thead th:hover,thead th.sorted{background:linear-gradient(135deg,#14B8C4 0%,var(--bm) 100%)}
...
.dec-pg-toggle.active{
  background:linear-gradient(180deg,#14B8C4 0%,var(--bm) 100%)!important;
...
.pb:hover{
  background:linear-gradient(180deg,var(--bl) 0%,#CFF7F9 100%);
...
.badge-oem{background:linear-gradient(135deg,#E3FBFC,#CFF7F9);color:var(--bm);border:1px solid #90CAF9}
...
.seg-blue{color:var(--bm);background:linear-gradient(135deg,#E3FBFC,#CFF7F9);border-color:#90CAF9}
...
.dec-chip:hover{border-color:var(--bm);background:linear-gradient(135deg,var(--bl),#CFF7F9);box-shadow:0 3px 8px rgba(0,96,160,.15);transform:translateY(-1px)}
...
.dec-comp-btn:hover{background:linear-gradient(180deg,#22C3D1 0%,#0E7C86 100%);box-shadow:var(--sh-hover);transform:translateY(-1px)}
...
.dec-db-btn:hover{border-color:var(--bm);background:linear-gradient(180deg,var(--bl),#CFF7F9);box-shadow:0 3px 8px rgba(0,96,160,.15);transform:translateY(-1px)}
      ...
      <div className="md">
        ...
        <div className="mb">
          ...
          <div style={{
            ...
            border: `1.5px solid ${target==='contingencia' ? '#F59E0B' : '#0E7C86'}`
          }}>
    ...
    <>
            ...
            <div style={{position:'relative',display:'inline-block'}}>
              <button
                ...
                style={{
                  ...
                  borderColor: isPreviewing ? '#C62828' : (dataSource==='contingencia' ? '#F59E0B' : '#0E7C86'),
                  color: dataSource==='contingencia' ? '#92400E' : '#0E7C86',
                      ...
                      <>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            background:'var(--bm,#0E7C86)',color:'#fff',
                          }}>
      ...
      <div className="ac-tw">
        {loading ? (
          ...
          <table>
            <thead><tr>
              <th style={{width:80,minWidth:70,background:'linear-gradient(135deg,var(--bd) 0%,#0B1220 100%)'}}>Acciones</th>
...
function AuthGate() {
  ...
  if (loading) return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',
      background:'linear-gradient(135deg,#0d2a4a,#111827)',fontFamily:"'Segoe UI',Arial,sans-serif"}}>
