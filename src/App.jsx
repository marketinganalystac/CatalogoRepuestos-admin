...
.ac-progress-title{
  font-size:1.1rem;font-weight:800;color:#0d2a4a;letter-spacing:.3px;
...
.ac-progress-label{font-size:0.78rem;color:rgba(13,42,74,.65);font-weight:500;overflow:hidden;text-overflow:ellipsis;display:block;margin-top:14px;max-width:100%}
.ac-progress-bar-bg{width:420px;max-width:60vw;background:rgba(0,0,0,.35);border-radius:20px;height:52px;overflow:hidden;position:relative;box-shadow:inset 0 1px 3px rgba(0,0,0,.3);margin-top:-76px;z-index:3;border:3px solid #e9ecef;}
.ac-progress-bar-fill{height:100%;background:linear-gradient(135deg,var(--bd) 0%,#15335c 100%);border-radius:20px;transition:width .3s ease;box-shadow:0 0 8px rgba(26,63,111,.5);position:relative}
