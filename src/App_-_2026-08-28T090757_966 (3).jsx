...
function ClasiIcon({ clasi, sub, size=56 }) {
...
/* ── Novedades — píldora flotante + ficha expandible ── */
.novf-wrap{position:fixed;top:14px;left:50%;transform:translateX(-50%);z-index:200;
...
.novf-pill{
  ...
  border-radius:999px;padding:10px 16px;box-shadow:0 8px 22px rgba(0,0,0,.22);
  white-space:nowrap;overflow:hidden;
}
.novf-veh{font-weight:800;font-size:0.82rem;letter-spacing:.2px}
...
.novf-cat b{font-size:0.76rem;letter-spacing:.3px}
.novf-cat small{font-size:0.62rem;opacity:.85;font-weight:500;overflow:hidden;text-overflow:ellipsis}
...
.novf-card{
  margin-top:10px;background:#fff;border:1px solid var(--gold);border-radius:16px;
  box-shadow:0 10px 30px rgba(0,0,0,.18);padding:6px 16px;width:340px;max-width:92vw;
  cursor:pointer;
}
.novf-tagline{font-size:0.6rem;font-weight:800;letter-spacing:.6px;color:var(--gold);padding:8px 0 0}
.novf-row{display:flex;align-items:center;gap:12px;padding:12px 0;border-bottom:1px solid var(--g2)}
.novf-row-last{border-bottom:none}
.novf-row:last-child{border-bottom:none}
.novf-ic{
  width:36px;height:36px;border-radius:50%;background:var(--gl);color:var(--gold);
  display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:1rem;font-weight:800;
}
.novf-row div{color:var(--bd);font-size:0.82rem}
.novf-row div b{color:var(--bd)}
.novf-gold{color:var(--gold)!important}
.novf-small{font-size:0.72rem;color:var(--g5);font-weight:500;margin-top:1px}
.novf-pager{
  margin-top:8px;display:flex;align-items:center;gap:10px;
  background:#fff;border-radius:999px;padding:4px 12px;box-shadow:0 4px 14px rgba(0,0,0,.15);
  font-size:0.72rem;color:var(--bd);font-weight:600;
}
.novf-pager button{background:none;border:none;cursor:pointer;font-size:1rem;color:var(--bd);
  padding:0 4px;line-height:1}
.novf-pager button:disabled{opacity:.3;cursor:default}
@media (max-width:640px){
  .novf-veh{font-size:0.72rem}
  .novf-cat b{font-size:0.68rem}
  .novf-card{width:290px}
}
...
function CatalogoApp() {
  ...
  return (
    ...
    <>
      ...
      {/* NOVEDADES — píldora flotante con lo último agregado o editado.
          Colapsada muestra un resumen de dos partes (vehículo | categoría);
          al tocarla se expande en una ficha con el detalle completo y un
          paginador para recorrer varias novedades pendientes. Si no hay
          novedades recientes, muestra un dato de la base como referencia. */}
      {novedadDisplay && (()=>{
        ...
        return (
          <div className="novf-wrap">
            <div className="novf-pill" onClick={()=>setNovedadesExpanded(v=>!v)}>
              {kind==='base' ? <Icon.Bell style={{width:16,height:16,flexShrink:0}}/> : <Icon.Alert style={{width:16,height:16,flexShrink:0}}/>}
              <span className="novf-veh">{vehiculo}</span>
              <span className="novf-sep"/>
              <span className="novf-cat-icon"><ClasiIcon clasi={clasi} sub={sub} size={16}/></span>
              ...
              <Icon.X onClick={e=>{e.stopPropagation();dismissNovedad();}} style={{width:12,height:12,opacity:.75,marginLeft:2}} title="Descartar"/>
            ...
            {novedadesExpanded && (
              <div className="novf-card" onClick={goToNovedad} title="Ver este registro en la tabla">
                ...
                <div className="novf-row">
                  <span className="novf-ic"><Icon.Car style={{width:16,height:16}}/></span>
                  <div><b>{vehiculo}</b></div>
                </div>
                <div className="novf-row">
                  <span className="novf-ic"><ClasiIcon clasi={clasi} sub={sub} size={18}/></span>
                  <div>
                ...
                <div className="novf-row">
                  <span className="novf-ic"><Icon.Tag style={{width:16,height:16}}/></span>
            ...
            {novedadesExpanded && novedadesPendientes.length>1 && (
