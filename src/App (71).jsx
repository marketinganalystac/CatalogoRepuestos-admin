      ...
      <div className="ac-login-outer">
        ...
        <div
          ...
          ref={(wrap) => {
            ...
            // Cuando Video 2 llega a 1 segundo antes del final del archivo,
            // reinicia el ciclo con Video 1 (evita mostrar el último segundo no deseado)
            let disparado = false;
            const vigilarFinalV2 = () => {
              if (!disparado && v2.duration && v2.currentTime >= v2.duration - 1) {
                disparado = true;
                cicloV1();
              }
            };
            v2.addEventListener("timeupdate", vigilarFinalV2);
