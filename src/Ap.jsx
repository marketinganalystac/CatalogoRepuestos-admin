...
function LoginScreen() {
  ...
  return (
    <div style={{
      ...
      backgroundImage:'url(https://cdn.jsdelivr.net/gh/marketinganalystac/CatalogoRepuestos-admin@main/public/login-bg.png)',
      ...
      <style>{`
        ...
        .ac-login-video{
          ...
          z-index:0;
          mask-image:radial-gradient(ellipse at center, #000 1%, transparent 100%);
          -webkit-mask-image:radial-gradient(ellipse at center, #000 45%, transparent 100%);
          filter:drop-shadow(0 0 75px rgba(0,0,0,0.45));
        }
        .ac-login-card{
