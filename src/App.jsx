...
function ClasiIcon({ clasi, sub, size=56, forceSvg=false }) {
  ...
  // un logo genérico único (/LogoO.png) en todos los casos. Cuando estén
  // listas las fotos reales, restaurar la lógica de SUBCLASI_IMAGES /
  // CLASI_IMAGES que queda más abajo comentada como referencia.
  ...
  if (forceSvg) {
    ...
    return <img src={TEMP_LOGO} alt={sub || clasi || 'Todas las categorías'} draggable={false}
        ...
        {(() => {
          ...
          return (<>
            ...
            {/* LAYOUT 2: Marca / Modelo / Período / Litraje
                Estos filtros dependen de Clasificación/Subclasificación:
                solo aparecen cuando el usuario ya eligió categoría o subcategoría.
                Así, al elegir "Batería" solo se filtran/muestran datos de batería,
                al elegir "Frenos" solo datos de frenos, etc. */}
            {(fClasi || fSub) ? (
              <div className="ac-fg">
              ...
              <div className="ac-fg" style={{opacity:.6,fontSize:'0.8rem',padding:'4px 2px'}}>
                Selecciona una Clasificación o Subclasificación para ver los filtros de Marca, Modelo, Período y Especificación.
              </div>
            )}
