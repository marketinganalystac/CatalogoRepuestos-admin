...
.dtl-info-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}
...
.dtl-body-split{display:grid;grid-template-columns:1fr 200px;gap:16px;align-items:start}
...
.dtl-code-chip-aside{width:100%;box-sizing:border-box}
...
const VerifBadge = ({ count, threshold, yaVerifique, loading, onClick, size = 26 }) => {
  ...
  return (
    ...
    >
      ...
      {/* palomita 1 */}
      <path d="M4.5 13.2l2.6 2.6 3.4-5.2" fill="none" stroke={check1?bright:dim} strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter"/>
      {/* palomita 2 */}
      <path d="M7.7 13.2l2.6 2.6 6.4-8.4" fill="none" stroke={check2?bright:dim} strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter"/>
    </svg>
  );
};
