...
.novf-pill{
  ...
  background:linear-gradient(135deg,#8A6B00,#6b5300);color:#fff;
  border-radius:999px;padding:6px 11px;box-shadow:0 2px 8px rgba(0,0,0,.15);
  white-space:nowrap;overflow:hidden;max-width:100%;
}
.novf-veh{font-weight:800;font-size:0.66rem;letter-spacing:.1px}
.novf-sep{width:1px;align-self:stretch;background:rgba(255,255,255,.4);flex-shrink:0}
.novf-cat-icon{display:flex;align-items:center;justify-content:center;flex-shrink:0;opacity:.95}
.novf-cat{font-size:0.6rem;letter-spacing:.2px;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
        ...
        {(() => {
          ...
          return (<>
            ...
            <div className="ac-fg2 ac-fg2-primary">
              ...
              {novedadDisplay && (()=>{
                const { kind, vehiculo, sub, clasi, codigo, specLine, modeloOriginal } = novedadDisplay;
                  ...
                  <div className="novf-inline-wrap" style={{gridColumn:'3 / span 2'}}>
                    <div className="novf-pill" onClick={()=>setNovedadesExpanded(v=>!v)}>
                      ...
                      <span className="novf-cat">
                        {(sub||clasi||'Novedad').toUpperCase()}{codigo?` / ${codigo}`:''}
                      </span>
