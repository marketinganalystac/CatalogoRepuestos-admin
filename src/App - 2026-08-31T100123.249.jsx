...
.cr-pill{
  ...
  background:var(--bd);
  padding:1px 20px;border-radius:6px;display:inline-flex;align-items:center;white-space:nowrap;
  letter-spacing:.03em;line-height:1.5;min-width:180px;
}
.cr-pill .ac-mark{background:rgba(255,255,255,.92);color:var(--bd);outline:none}
.btn-copy{
  padding:3px 7px;
  background:rgba(255,255,255,.22);
  border:1px solid rgba(255,255,255,.4);border-radius:4px;font-size:0.62rem;cursor:pointer;color:#fff;margin-left:8px;
...
function CatalogoApp() {
  ...
  // Cada 10s: si hay varias novedades pendientes, avanza a la siguiente
  // (cíclico); si no hay ninguna, rota el dato de muestra de la base. En
  // ambos casos, si la ficha estaba expandida, se colapsa sola — no hace
  // falta tocar la flechita.
  useEffect(()=>{
  ...
  return (
    ...
    <>
              ...
              {novedadDisplay && (()=>{
                ...
                return (
                  <div className="novf-inline-wrap" key={codLine||vehiculo} style={{gridColumn:'3 / span 2'}}>
                    <div className="novf-pill novf-pill-rise" onClick={goToNovedad} title="Ver este registro en la tabla">
      ...
      <div className="ac-sr-mid">
        ...
        <button className="btn btn-o" onClick={clearAll}><Icon.X style={{marginRight:6,verticalAlign:-2}}/>Limpiar</button>
      </div>
