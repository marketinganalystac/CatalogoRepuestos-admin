...
}.ac-progress-bar-fill{height:100%;background:linear-gradient(90deg,#1c5a91 0%,#2A8FD8 60%,#4facdb 100%);border-radius:9px;transition:width .3s ease;box-shadow:0 0 6px rgba(42,143,216,.35);position:relative}
.ac-progress-bar-fill::after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,rgba(255,255,255,.18) 0%,transparent 45%);border-radius:9px}
