...
.ac-progress-overlay{
  ...
  display:flex;align-items:center;justify-content:center;
  background:rgba(8,18,32,.55);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);
  opacity:0;pointer-events:none;transition:opacity .25s ease;
}
.ac-progress-overlay.active{opacity:1;pointer-events:all}
.ac-progress-card{
  background:linear-gradient(160deg,rgba(26,63,111,.92) 0%,rgba(13,40,78,.94) 100%);
  backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);
  border:1px solid rgba(255,255,255,.08);border-radius:22px;
  padding:36px 44px 40px;width:50vw;height:50vh;max-width:none;max-height:none;min-width:340px;
  display:flex;flex-direction:column;align-items:center;justify-content:center;
  text-align:center;
  box-shadow:0 24px 60px rgba(0,0,0,.5),0 0 90px rgba(0,96,160,.18),inset 0 1px 0 rgba(255,255,255,.06);
}
.ac-progress-title{
  font-size:0.98rem;font-weight:800;color:#fff;letter-spacing:.3px;
...
.ac-progress-video-wrap{
  position:relative;width:320px;max-width:88%;
  margin:6px 0 22px;border-radius:18px;overflow:hidden;
  border:2px solid rgba(212,168,0,.55);
...
.ac-progress-pct{
  ...
  font-size:0.95rem;font-weight:800;color:#1a1200;line-height:1;
  letter-spacing:.5px;z-index:2;text-shadow:none;
}
.ac-progress-label{font-size:0.72rem;color:rgba(255,255,255,.75);font-weight:500;overflow:hidden;text-overflow:ellipsis;display:block;margin-top:14px;max-width:100%}
.ac-progress-bar-bg{width:68%;background:rgba(0,0,0,.35);border-radius:20px;height:26px;overflow:hidden;position:relative;box-shadow:inset 0 1px 3px rgba(0,0,0,.3)}
.ac-progress-bar-fill{height:100%;background:linear-gradient(90deg,#f0c000,var(--gold),#f5ca00);border-radius:20px;transition:width .3s ease;box-shadow:0 0 8px rgba(212,168,0,.5);position:relative}
