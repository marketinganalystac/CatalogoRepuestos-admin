...
.ac-fg2-primary{grid-template-columns:1fr 1fr 1.6fr;align-items:stretch}
.ac-fg2-primary select{border-color:var(--bm);font-weight:700}
.ac-fg2-primary .ac-fl label{color:var(--bd);font-weight:800}

/* Panel de ícono — tercera columna de ac-fg2-primary, en la misma fila que
   Clasificación/Subclasificación. Sin marco, integrado al fondo como un
   KPI card: el ícono se apoya directamente sobre el panel, sin caja visible. */
.ac-clasi-icon-panel{
...
.ac-clasi-icon-panel svg{opacity:.16;flex-shrink:0;width:64px;height:64px}
.ac-clasi-icon-label{font-size:0.62rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;opacity:.4;position:absolute;left:6px;bottom:4px}
        ...
        {(() => {
          ...
          return (<>
            {/* LAYOUT 1: Clasificación / Subclasificación — selección principal,
                más el ícono SVG opaco (condicionado a la Clasificación activa)
                en la misma fila, ocupando el espacio restante a la derecha */}
