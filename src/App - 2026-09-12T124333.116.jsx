...
const ModalDetail = ({ record, onClose, onEdit, onReported }) => {
  const toast = useToast();
...
function CatalogoApp() {
  ...
  return (
    ...
    <>
      ...
      {modalDetail && <ModalDetail  record={modalDetail}  onClose={()=>setModalDetail(null)} onEdit={r=>{setModalDetail(null);setModalEdit(r);}} onReported={addReporteLocal}/>}
