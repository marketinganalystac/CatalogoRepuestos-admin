...
.ac-progress-bar-bg{width:900px;max-width:60vw;background:rgba(0,0,0,.35);border-radius:20px;height:90px;overflow:hidden;position:relative;box-shadow:inset 0 1px 3px rgba(0,0,0,.3);margin-top:-250px;z-index:3;border:none;}
