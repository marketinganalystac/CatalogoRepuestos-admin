...
function findByNormalizedKey(map, value) {
  ...
  return idx[_normImgKey(value)] || null;
}
...
.ac-clasi-icon-panel img.ac-clasi-img{
  opacity:.1 !important ;position:absolute;right:0;top:50%;transform:translateY(-50%);
    ...
    <>
          ...
          return (<>
            ...
            {(fClasi || fSub) ? (
              <div className="ac-fg">
                ...
                {renderFilter({label:'Especificación', val:fLitraje, set:onLitrajeChange, opts:availableLitrajes, placeholder:'Todas'})}
              </div>
            ) : (
      ...
      <div className="ac-sb">
        ...
        <span style={{marginLeft:'auto',display:'flex',gap:5,flexWrap:'nowrap'}}>
          ...
          {fSub   &&<span className="ac-tag" style={{background:'rgba(255,255,255,.25)',display:'inline-flex',alignItems:'center',gap:4}}><Icon.Folder style={{width:11,height:11}}/>{fSub}</span>}
          {fLitraje &&<span className="ac-tag" style={{background:'rgba(255,255,255,.25)',display:'inline-flex',alignItems:'center',gap:4}}>{fLitraje}</span>}
