...
.ac-progress-overlay{
  ...
  display:flex;align-items:center;justify-content:center;
  background:rgba(8,18,32,.72);backdrop-filter:blur(5px);-webkit-backdrop-filter:blur(5px);
...
.ac-progress-card{
  ...
  padding:30px 38px;min-width:320px;max-width:88vw;text-align:center;
  box-shadow:var(--sh-modal);
  transform:translateY(0);
}
.ac-progress-spin{width:34px;height:34px;border:3px solid rgba(255,255,255,.2);border-top-color:var(--gold);
  border-radius:50%;margin:0 auto 16px;animation:spin .8s linear infinite}
@keyframes spin{to{transform:rotate(360deg)}}
.ac-progress-label{font-size:0.68rem;color:rgba(255,255,255,.92);font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:block;margin-bottom:14px}
.ac-progress-bar-bg{background:rgba(255,255,255,.14);border-radius:20px;height:9px;overflow:hidden;box-shadow:inset 0 1px 3px rgba(0,0,0,.25)}
...
.ac-progress-pct{display:block;margin-top:10px;font-size:0.63rem;color:var(--gold);font-weight:700;text-shadow:0 1px 3px rgba(0,0,0,.3)}
