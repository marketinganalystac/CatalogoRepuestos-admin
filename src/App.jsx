...
@media(max-width:680px){.dtl-info-grid{grid-template-columns:1fr}.dtl-hcode{max-width:160px}.dtl-verif-wrap{margin:0 6px}}
...
const VerifBadge = ({ count, threshold, yaVerifique, loading, onClick, size = 26 }) => {
  ...
  return (
    ...
    >
      ...
      {/* palomita 1 */}
      <path d="M4.5 13.2l2.6 2.6 3.4-5.2" fill="none" stroke={check1?bright:dim} strokeWidth="2" strokeLinecap="square" strokeLinejoin="miter"/>
      {/* palomita 2 */}
      <path d="M11.5 13.2l2.6 2.6 6.4-8.4" fill="none" stroke={check2?bright:dim} strokeWidth="2" strokeLinecap="square" strokeLinejoin="miter"/>
    </svg>
  );
};
    ...
    <div className="mo show">
      <div className="md dtl-md">
        ...
        <div className="dtl-body">
          ...
          {/* Pie de panel — listado de Código de Repuesto (1,2,3,4,5) */}
          <div className="dtl-codes-footer">
            ...
            {codigosLista.length === 0 ? (
              ...
              <div className="dtl-codes-chips">
                {codigosLista.map((c,i) => (
                  <div key={i+c.val} className="dtl-code-chip">
