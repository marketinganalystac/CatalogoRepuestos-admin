...
.ac-progress-card{
  ...
  padding:44px 48px 38px;width:auto;height:auto;max-width:min(360px,88vw);max-height:none;min-width:280px;
  display:flex;flex-direction:column;align-items:center;justify-content:center;
  text-align:center;
  box-shadow:0 30px 70px rgba(6,14,28,.35),0 8px 20px rgba(6,14,28,.15);
...
.ac-progress-title{
  font-size:0.92rem;font-weight:700;color:var(--bd);letter-spacing:.1px;
  margin-top:22px;display:flex;align-items:center;gap:8px;
}
.ac-progress-title .dot{display:none}
.ac-progress-spin-wrap{position:relative;width:76px;height:76px}
.ac-progress-spin{
...
@keyframes spin{to{transform:rotate(360deg)}}
.ac-progress-label{font-size:0.68rem;color:var(--g5);font-weight:500;overflow:hidden;text-overflow:ellipsis;
  display:block;margin-top:8px;max-width:280px;white-space:nowrap}
