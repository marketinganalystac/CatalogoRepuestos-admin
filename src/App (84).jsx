...
.ac-progress-video-wrap::after{
  content:'';position:absolute;left:-40px;right:-40px;bottom:0;height:70px;
  background:linear-gradient(180deg,rgba(38,41,46,0) 0%,rgba(38,41,46,.75) 60%,rgba(38,41,46,.98) 100%);
...
@keyframes spin{to{transform:rotate(360deg)}}
.ac-progress-pct{
  font-size:1.4rem;font-weight:800;color:#4facdb;line-height:1;
  letter-spacing:.5px;margin-top:-38px;margin-bottom:14px;position:relative;z-index:6;
  text-shadow:0 1px 4px rgba(0,0,0,.5);
}
.ac-progress-label{font-size:0.78rem;color:rgba(255,255,255,.65);font-weight:500;overflow:hidden;text-overflow:ellipsis;display:block;margin-top:12px;max-width:100%;letter-spacing:.2px}
.ac-progress-bar-bg{
  width:420px;
  max-width:60vw;
...
.ac-progress-bar-fill{height:100%;background:linear-gradient(90deg,#1c5a91 0%,#2A8FD8 55%,#4facdb 100%);border-radius:999px;transition:width .3s ease;box-shadow:0 0 10px rgba(79,172,219,.65);position:relative}
.ac-progress-bar-fill.indeterminate{width:34%!important;animation:progress-slide 1.2s ease-in-out infinite}
