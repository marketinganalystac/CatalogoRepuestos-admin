...
.ac-fg2-primary{grid-template-columns:1fr 1fr;align-items:stretch;position:relative}

/* Panel de ícono — flota como fondo decorativo detrás/al lado de
   Clasificación/Subclasificación, sin ocupar espacio propio en el grid
   (position:absolute), para que no genere filas ni huecos vacíos. */
.ac-clasi-icon-panel{
...
.ac-clasi-icon-label{font-size:0.62rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;opacity:.4;position:absolute;right:6px;bottom:-16px;white-space:nowrap}
