...
// letra con las claves definidas arriba (mayúsculas, tildes, plural, etc.).
...
function findByNormalizedKey(map, value) {
  ...
  // Match exacto → si no, prueba variantes singular/plural (la BD puede decir
  // "Amortiguador" y el archivo en /public llamarse "amortiguadores.png", o viceversa).
  return idx[key] || idx[key + 's'] || (key.endsWith('s') ? idx[key.slice(0, -1)] : null) || null;
}
...
.ac-clasi-icon-panel img.ac-clasi-img{
  opacity:.1 !important ;position:absolute;right:0;top:50%;transform:translateY(calc(-50% + 70px)) rotate(45deg);
    ...
    <>
        ...
        {(() => {
          ...
          return (<>
            ...
            <div className="ac-fg2 ac-fg2-primary">
              {renderFilter({label:'Clasificación', icon:<Icon.Search style={{width:11,height:11}}/>, val:fClasi, set:onClasiChange, opts:availableClasif, placeholder:'Todas'})}
      ...
      <div className="ac-sb">
        ...
        <span style={{marginLeft:'auto',display:'flex',gap:5,flexWrap:'nowrap'}}>
          ...
          {fClasi &&<span className="ac-tag" style={{background:'rgba(255,255,255,.25)',display:'inline-flex',alignItems:'center',gap:4}}><Icon.Search style={{width:11,height:11}}/>{fClasi.substring(0,22)}</span>}
