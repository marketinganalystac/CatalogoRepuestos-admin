...
.novf-card{
  ...
  box-shadow:0 10px 26px rgba(0,0,0,.18);padding:0 12px 2px;width:230px;max-width:80vw;
  cursor:pointer;overflow:hidden;
}
.novf-tagline{
  display:block;width:calc(100% + 24px);box-sizing:border-box;
  margin:0 -12px 6px;padding:8px 12px;
  font-size:0.56rem;font-weight:800;letter-spacing:.5px;color:#fff;text-align:center;
