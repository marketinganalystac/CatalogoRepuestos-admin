...
.ac-progress-pct{
  ...
  min-width:64px;padding:5px 14px;margin-bottom:16px;
  background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.16);
  border-radius:999px;backdrop-filter:blur(4px);
  font-size:0.95rem;font-weight:700;color:#fff;line-height:1;letter-spacing:.3px;
}
.ac-progress-label{font-size:0.78rem;color:rgba(255,255,255,.65);font-weight:500;overflow:hidden;text-overflow:ellipsis;display:block;margin-top:14px;max-width:100%;letter-spacing:.2px}
.ac-progress-bar-bg{
  width:520px;
  max-width:60vw;
...
.ac-progress-bar-fill{
  height:100%;border-radius:999px;position:relative;transition:width .3s ease;
  background:linear-gradient(90deg,#1c5a91 0%,#2A8FD8 50%,#5fb8e8 100%);
  box-shadow:0 0 12px rgba(95,184,232,.55);
}
.ac-progress-bar-fill::after{
