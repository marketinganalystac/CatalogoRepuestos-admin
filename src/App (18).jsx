...
function LoginScreen() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position:'relative', width:'min(400px,30%)' }}>
        ...
        <video
          ...
          style={{
            ...
            boxShadow:'rgba(0, 0, 0, 0.45) 0px 0px 0px',
            transform:'translateX(-209px)',
            zIndex:0,
            // Difuminado de bordes propio del video: se desvanece hacia afuera
            // revelando el gradiente real de fondo (#14304B → #163147 → #1B527E)
        ...
        <div style={{
          ...
          boxShadow:'0 32px 80px rgba(0,0,0,.45)', overflow:'hidden'
        }}>
        {/* Header */}
